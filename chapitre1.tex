...
de classification de séquence ou de prédiction de phénotype.

\subsubsection{Classification de séquences}
La classification de séquence sert à assigner une catégorie à une séquence de nucléotide, qui peut
être un taxon,

\subsubsection{Prédiction de phénotype}
