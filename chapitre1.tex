...
L'apprentissage automatique consiste à permettre à un ordinateur d'apprendre à résoudre un problème
sans avoir à spécifier explicitement de méthodes de résolution \cite{samue1959}. Dans ce contexte,
<< apprendre >> désigne la capacité d'effectuer une tâche avec une plus grande efficacité, par
exemple, d'effectuer une classification avec une plus grande précision. Il s'agit d'un domaine vaste
de recherche; cette section en présente seulement les principes de bases, les architectures les plus
utilisées de réseaux neuronaux et leur application à la métagénomique.
...
- entrées / sorties
- classique / NN
- pré-entraînement / supervisé / non-supervisé
