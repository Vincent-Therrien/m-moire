...
\newglossaryentry{hyperparametre} {
  name={hyperparamètre},
  type=definitions,
  description={Valeur numérique configurée avant l'entraînement d'un modèle d'apprentissage automatique  qui détermine comment ses paramètres son ajustés}
}

\newglossaryentry{indel} {
  name={indel},
  type=definitions,
  description={Contraction de insertion / délétion, un type de modification de l'ADN qui consiste à substituer ou éliminer un ou plusieurs nucléotide dans une séquence.}
}
...
\newglossaryentry{parametre} {
  name={paramètre},
  type=definitions,
  description={Valeur numérique contenue dans un modèle d'apprentissage automatique ajustée durant l'entraînement qui détermine le comportement du modèle}
}
